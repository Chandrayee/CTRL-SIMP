...
import re
import random
from preprocessing import load_data, post_processing_single_angle, get_multiangle_data, post_processing_single_angle_only_S
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ctrl', type = bool, default = True)
    parser.add_argument('--batch_size', type = int, default = 4)
    args = parser.parse_args()
    
    if args.multi_angle or args.ctrl:
        ...
        with open('./Datasets/annotated_data/train_annotations_slots_single_angle.json', 'r') as f:
    ...
    if args.merged_output:
        train_model_with_merged_outputs(model_dict['model'], model_dict['tokenizer'], model_dict['cuda_device'], training_data, dev_data, batch_size = args.batch_size, shuffle = args.shuffle, in_place_annotation = args.ip_ann, one_slot = args.one_slot, data_dir = DEFAULT_RESULTS_DIR)
    else:
