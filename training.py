...
from model import load_model, run_model, run_model_with_outputs, get_eval_data, model_input_format
import torch
import pandas as pd
import pickle
import json
        ...
        with torch.autograd.set_detect_anomaly(True):
            for i, batch in enumerate(gen):
                ...
                for input, output in batch:
                    ...
                    outputs = []
                    for output_string, output_text in enumerate(output_strings):
